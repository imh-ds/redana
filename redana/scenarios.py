...
def generate_stage1_linear_fixture(
    ...
    approximately nothing beyond it.
    """
...
def generate_stage1_nonlinear_fixture(
    ...
    F3/Step4-validated shape (``0.7*(Z^2-1)``), which has exactly zero
    linear covariance with its source in population.
    """
    ...
    x1 = e1
    x2 = _FIXTURE_COEFFICIENT * (x1**2 - 1) + e2
    x3 = e3
    x4 = _FIXTURE_COEFFICIENT * (x3**2 - 1) + e4
    x5, x6 = e5, e6
